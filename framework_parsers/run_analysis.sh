...
python3 ./analyse_frameworks.py "constituency/constituency_analysis_smerged.json" "constituency_relations_smerged_counts.png" -p -l No,Yes
# python3 ./analyse_frameworks.py "rst/rst_analysis.json" "rst_relations_counts.png" -p -l No,Yes
